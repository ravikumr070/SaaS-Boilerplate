...
namespace Domain.EmailSend;
public class EmailSendModel : AuditableEntity, IAggregateRoot
{
    public int Id { get;  set; }


    public int Email_Send_Id { get; private set; }
    [StringLength(200)]
