...
public abstract class BaseDbContext : IdentityDbContext<ApplicationUser, ApplicationRole, string, IdentityUserClaim<string>, IdentityUserRole<string>, IdentityUserLogin<string>, ApplicationRoleClaim, IdentityUserToken<string>>
{
    ...
    protected BaseDbContext(ITenantProvider tenantProvider, DbContextOptions options, ICurrentUser currentUser, ISerializerService serializer, IOptions<DatabaseSettings> dbSettings, IEventPublisher events, IOptions<AzureDatabaseSettings> azuredbSettings)
        : base(options)
    {
    ...
    public DbSet<LoginAttempt.LoginAttempt> LoginAttempts => Set<LoginAttempt.LoginAttempt>();
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            optionsBuilder.UseDatabase(_dbSettings.DBProvider, tenant.ConnectionString);
        }
    }
