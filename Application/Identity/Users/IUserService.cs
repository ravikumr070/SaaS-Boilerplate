...
public interface IUserService : ITransientService
{
    ...
    Task<List<RoleByMenuMasterDto>> GetRoleByMenuMastersAsync(string userId, CancellationToken cancellationToken);
    ...
    Task<List<LoginAttemptDto>> GetBuyIdLoginAttempt(string userId, CancellationToken cancellationToken);
}