...
public class RolesController : VersionNeutralApiController
{
    ...
    [HttpGet]
    [MustHavePermission(UserAction.View, UserResource.Roles)]
    ...
    [MustHavePermission(UserAction.View, UserResource.RoleClaims)]
    ...
    [MustHavePermission(UserAction.Update, UserResource.RoleClaims)]
    ...
    [HttpPost]
    [MustHavePermission(UserAction.Create, UserResource.Roles)]
    ...
    [HttpDelete("{id}")]
    [MustHavePermission(UserAction.Delete, UserResource.Roles)]
